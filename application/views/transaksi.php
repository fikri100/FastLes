...
<body>
	...
	<nav class="navbar">
		...
		<div class="panel-body">
		  	<?php echo form_open_multipart('MuridCtl/pesan'); ?>
			<div class="form-group">
				<label class="col-md-4 control-label" for="tanggalPesan">Tanggal Les</label>  
				<div class="col-md-5">
			  <input id="tanggalPesan" name="tanggalPesan" type="date" placeholder="Tanggal Pesan" class="form-control input-md" required="">
			  </div>
			</div>
			<div class="form-group">
				<label class="col-md-4 control-label" for="jam">Total Jam</label>  
				<div class="col-md-5">
			  <input id="jam" name="jam" type="text" placeholder="Total Jam" class="form-control input-md" required="">
			  </div>
			</div><br><br>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			    <button type="submit" class="btn-lg btn-danger">PESAN</button>
			  </div>
			</div>
			<?php echo form_close(); ?>
		  </div>
