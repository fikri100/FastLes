  ...
  <div class="col-md-9">
		<div class="panel panel-default">
		  <div class="panel-heading"style="background-color:  #1E8BC3;">
		    <h3 class="panel-title">Daftar Detail </h3>
		  </div>
      <div class="panel-body">
          <br><br>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo base_url() ?>index.php/DetailCtl/delete/<?php echo $value['id'] ?>"class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
              </td>
            </tr>
          <?php endforeach ?>
          </tbody>
