...
<body>
	...
	<nav class="navbar">
		...
		<div class="panel-body">
		  	<?php echo form_open_multipart('MuridCtl/ulasan'); ?>
			<div class="form-group">
				<label class="col-md-4 control-label" for="ulasan">Ulasan</label>  
				<div class="col-md-5">
			  <input id="ulasan" name="ulasan" type="text" placeholder="ulasan" class="form-control input-md" required="">
			  </div>
			</div>
			<br><br>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			    <button type="submit" class="btn-lg btn-danger">Kirim</button>
			  </div>
			</div>
			<?php echo form_close(); ?>
		  </div>
