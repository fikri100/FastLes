  ...
  <div class="row">
      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	  <?php echo form_open_multipart('GuruCtl/updateGuru/'.$getData['idGuru']); ?>
        <legend>Silahkan registrasi untuk menjadi Murid di FastLes</legend>
            <div class="form-group">
            <label for="nama">Nama</label>
            <input type="text" class="form-control" id="namaGuru" name="namaGuru" value="<?php echo $getData['namaGuru'] ?>" placeholder="Nama Guru">
            </div>
            <div class="form-group">
            ...
            <br>
            <label class="radio-inline" value="<?php echo $getData['jenisKelamin'] ?>">
