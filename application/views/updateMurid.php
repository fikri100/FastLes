      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  <div class="panel-heading"style="background-color:  #1E8BC3;">
		    <h3 class="panel-title">Update Murid</h3>
		  </div>
		  <div class="panel-body">
		  	<?php echo form_open_multipart('MuridCtl/updateMurid/'.$getData['idMurid']); ?>
        <legend>Silahkan update data murid</legend>
            <div class="form-group">
            <label for="nama">Nama Murid</label>
            <input type="text" class="form-control" id="namaMurid" name="namaMurid" value="<?php echo $getData['namaMurid'] ?>" placeholder="Nama Murid">
            </div>
            <div class="form-group">
            <label for="organisasi">Tanggal Lahir</label>
            <input type="date" class="form-control" id="tglLahir" name="tglLahir" value="<?php echo $getData['tglLahir'] ?>" placeholder="Tanggal Lahir">
            </div>
            <div class="form-group">
            <label for="no_hp">No Telp</label>
            <input type="text" class="form-control" id="noTelp" name="noTelp" value="<?php echo $getData['noTelp'] ?>" placeholder="No Telp">
            </div>
            <div class="form-group">
            ...
            <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $getData['alamat'] ?>" placeholder="Alamat">
            </div>
            <div class="form-group">
            ...
            <input type="text" class="form-control" id="username" name="username" value="<?php echo $getData['username'] ?>" placeholder="username">
            </div>
            <div class="form-group">
            <label for="password">Password</label>
            <input type="password" class="form-control" id="password" name="password" value="<?php echo $getData['password'] ?>" placeholder="password">
            </div>
