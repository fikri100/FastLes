...
<div class="container-fluid column-starter">
  ...
  <div class="col-md-9">
      ...
      <div class="panel-body">
         <a href="<?php echo base_url() ?>index.php/MuridCtl/insert" class="btn btn-primary my-3">Tambah</a> <br><br>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><img src="<?php echo base_url()?>./assets/upload/<?php echo $value['foto']?>" width="100" height="100" alt=""></td>
              <td><?php echo $value['username'] ?></td>
              <td><?php echo $value['password'] ?></td>
              <td>
                <a href="<?php echo base_url() ?>index.php/MuridCtl/updateMurid/<?php echo $value['idMurid'] ?>" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-pencil"></span>
                <a href="<?php echo base_url() ?>index.php/MuridCtl/delete/<?php echo $value['idMurid'] ?>"class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
              </td>
            </tr>
          <?php endforeach ?>
          </tbody>
