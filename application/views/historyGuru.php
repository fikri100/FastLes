			...
			<div class="row">
				<div class="col-sm-3">
					<div class="list-group" style="border: none;">
					  ...
					  <a href="<?php echo site_url(); ?>/history/index"><button type="button" class="list-group-item active" style="border: none;">History</button></a>
				...
				<div class="col-sm-9">
			        ...
			        <tbody>
			            <?php foreach ($historyGuru_list as $key => $value):?>
					            <tr>
					              ...
					              <td>
					              	<a href="<?php echo site_url(); ?>/History/terima/<?php echo $value['id'] ?>" class="btn-sm btn-primary">Terima</a>
					              	<a href="<?php echo site_url(); ?>/History/tolak/<?php echo $value['id'] ?>" class="btn-sm btn-danger">Tolak</a>
					              	<a href="<?php echo site_url(); ?>/History/terlaksana/<?php echo $value['id'] ?>" class="btn-sm btn-success">Terlaksana</a>
					              </td>
					            </tr>
					          <?php endforeach ?>
			            </tbody>
